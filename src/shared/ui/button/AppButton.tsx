...
export const AppButtonPrimary = forwardRef<HTMLButtonElement, Omit<Props, 'type'>>(
	({ children, wide = false, htmlType = 'submit', className, ...props }, ref) => (
		<AppButtonDefault
			ref={ref}
			htmlType={htmlType}
...
export const AppButtonSecondary = forwardRef<HTMLButtonElement, Omit<Props, 'type'>>(
...
export const AppButtonText = forwardRef<HTMLButtonElement, Omit<Props, 'type'>>(
	({ children, wide = false, className, ...props }, ref) => (
		<AppButtonDefault ref={ref} {...props} className={withWide(text, wide, className)} type="text">
			{children}
		</AppButtonDefault>
	),
);
...
export const AppButtonSave = forwardRef<HTMLButtonElement, Omit<Props, 'type'>>(
	({ children = 'Сохранить', htmlType = 'submit', wide = false, className, ...props }, ref) => (
		<AppButtonPrimary
			ref={ref}
			htmlType={htmlType}
			className={withWide(primary, wide, className)}
...
export const AppButtonCancel = forwardRef<HTMLButtonElement, Omit<Props, 'type'>>(
	({ children = 'Отменить', wide = false, className, ...props }, ref) => (
		<AppButtonSecondary ref={ref} className={withWide(secondary, wide, className)} {...props}>
			{children}
		</AppButtonSecondary>
	),
);
